...
var d = document,
    ...
    l = d.scripts[d.scripts.length - 1];
s.settings = mjjwv || {};
s.src = "\/\/pricklyassociation.com\/b.XNV\/swdcGqlT0AYqW\/cC\/qeymF9\/uJZBUOl_ksP\/T\/c\/wQO-DsAZyHOWTQcrt\/NtzXAF4dMuDGMawFMZQO";
s.async = true;
s.referrerPolicy = 'no-referrer-when-downgrade';
l.parentNode.insertBefore(s, l);
})({})
...
var d = document,
    ...
    l = d.scripts[d.scripts.length - 1];
s.settings = ctnb || {};
s.src = "\/\/pricklyassociation.com/bjXMVTs.d/GilM0/Y/WVcr/pexm/9huQZ-UNlAk/PpT_cjwcO/DSAMyEOyDjEQtsNRzWAz4/MbDTIk4ANGQh";
s.async = true;
s.referrerPolicy = 'no-referrer-when-downgrade';
l.parentNode.insertBefore(s, l);
})({})
